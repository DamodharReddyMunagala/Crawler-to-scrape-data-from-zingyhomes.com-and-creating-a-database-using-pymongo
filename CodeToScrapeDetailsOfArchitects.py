# Crawler-to-scrape-data-from-zingyhomes.com-and-creating-a-database-using-pymongo
import requests
...
for i in range(1,243):
    pages.append('http://www.zingyhomes.com/find-architects/?page=' + str(i) + '&')
...
def Page(url):
    ...
    for data in soup.findAll('div', {'class' : 'left-project-profile-detial'}):
        firmUrl.append('http://www.zingyhomes.com' + data.find('a', {'target' : '_blank'}, href = re.compile('^(/architect)')).attrs['href'])
...
db = connection.hutstoryZingyHomes
